...
import 'package:digital_payments_fixed/controller/add_money_controller.dart';
import 'package:digital_payments_fixed/controller/subscription_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SubscriptionGuard(
        customMessage: 'Add Money feature requires a premium subscription',
