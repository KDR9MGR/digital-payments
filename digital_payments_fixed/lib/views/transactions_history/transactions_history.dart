...
import 'package:digital_payments_fixed/data/transaction_model.dart';
import 'package:digital_payments_fixed/utils/custom_color.dart';
import 'package:digital_payments_fixed/utils/custom_style.dart';
import 'package:digital_payments_fixed/utils/dimensions.dart';
import 'package:digital_payments_fixed/utils/strings.dart';
import 'package:digital_payments_fixed/views/auth/wallet_view_model.dart';
import 'package:digital_payments_fixed/widgets/details_transaction_widget.dart';
import 'package:digital_payments_fixed/widgets/latest_transaction_widget.dart';
import 'package:digital_payments_fixed/widgets/primary_appbar.dart';
import 'package:digital_payments_fixed/widgets/subscription_guard.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SubscriptionGuard(
        ...
        child: Consumer<WalletViewModel>(builder: (context, walletViewModel, child) {
