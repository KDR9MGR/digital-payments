...
import 'package:digital_payments_fixed/binding/onboard_binding.dart';
import 'package:digital_payments_fixed/views/auth/congratulations_screen.dart';
import 'package:digital_payments_fixed/views/auth/forget_password_screen.dart';
import 'package:digital_payments_fixed/views/auth/login_screen.dart';
import 'package:digital_payments_fixed/views/auth/otp_screen.dart';
import 'package:digital_payments_fixed/views/auth/reset_password_screen.dart';
import 'package:digital_payments_fixed/views/auth/sign_up_screen.dart';
import 'package:digital_payments_fixed/views/bank_info/bank_info_screen.dart';
import 'package:digital_payments_fixed/views/my_cards/add_new_card_screen.dart';
import 'package:digital_payments_fixed/views/my_cards/my_cards_screen.dart';
import 'package:digital_payments_fixed/views/navigation_screen.dart';
import 'package:digital_payments_fixed/views/onboard/onboard_screen.dart';
import 'package:digital_payments_fixed/views/transactions_history/transactions_history.dart';
import 'package:digital_payments_fixed/views/welcome_screen.dart';
import 'package:digital_payments_fixed/views/withdraw/withdraw_money_screen.dart';
import 'package:digital_payments_fixed/views/subscription/subscription_screen.dart';
import 'package:digital_payments_fixed/views/subscription/subscription_plans_screen.dart';
