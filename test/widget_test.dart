...
void main() {
  group('Critical User Flow Tests', () {
    ...
    group('Error Handling Tests', () {
      ...
      test('Payment error handling', () {
        ...
        for (final error in paymentErrors) {
          ...
          bool needsNewPaymentMethod = error.contains('expired') || error.contains('invalid');
    ...
    group('Edge Case Tests', () {
      ...
      test('Subscription state consistency', () {
        ...
        final subscriptionStates = ['active', 'expired', 'cancelled', 'pending'];
      ...
      test('Rate limiting validation', () {
        ...
        final recentRequests = requestTimestamps.where(
    ...
    group('Data Validation Tests', () {
      ...
      test('Currency validation', () {
        ...
        for (final currency in invalidCurrencies) {
          final isValid = currency.length == 3 && currency == currency.toUpperCase();
          expect(isValid, isFalse);
        }
      });
  ...
  group('Security Tests', () {
    test('API key protection', () {
      ...
      final isValidKey = invalidApiKey.startsWith('sk_') && invalidApiKey.length > 20;
    ...
    test('Password strength validation', () {
      ...
      for (final password in strongPasswords) {
        ...
        expect(hasUppercase && hasLowercase && hasDigit && hasSpecial && isLongEnough, isTrue);
      }
      ...
      for (final password in weakPasswords) {
        ...
        final isStrong = hasUppercase && hasLowercase && hasDigit && hasSpecial && isLongEnough;
