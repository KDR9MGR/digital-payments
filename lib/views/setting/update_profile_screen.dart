...
class _UpdateProfileScreenState extends State<UpdateProfileScreen> {
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                'To update mobile number, please contact support',
                style: TextStyle(
                  fontSize: 12,
  ...
  Future<Map<String, dynamic>> _getUpdatedFields() async {
    ...
    if (settingsController.firstNameController.text !=
        _userProvider.user?.firstName) {
      updatedFields['first_name'] =
          settingsController.firstNameController.text.trim();
    }
    if (settingsController.lastNameController.text !=
        _userProvider.user?.lastName) {
      updatedFields['last_name'] =
          settingsController.lastNameController.text.trim();
    }
    if (settingsController.emailController.text !=
        _userProvider.user?.emailAddress) {
      updatedFields['email_address'] =
          settingsController.emailController.text.trim();
    }
