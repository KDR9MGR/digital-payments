...
import 'package:xpay/widgets/video_player_widget.dart';
...
class _DashboardScreenState extends State<DashboardScreen>
                                      ...
                                      Flexible(
                                        child: Builder(
                                          builder: (context) {
                                            // Debug logging
                                            print(
                                              '🔍 DEBUG: User data: ${userProvider.user?.toMap()}',
                                            );
                                            print(
                                              '🔍 DEBUG: FirstName: ${userProvider.user?.firstName}',
                                            );
                                            print(
                                              '🔍 DEBUG: LastName: ${userProvider.user?.lastName}',
                                            );
                                            print(
                                              '🔍 DEBUG: Email: ${userProvider.user?.emailAddress}',
                                            );
                                            ...
                                            if (userProvider.user != null) {
                                              ...
                                              // Priority 2: Use lastName if firstName is empty
                                              else if (user
                                                      .lastName
                                                      ?.isNotEmpty ==
                                                  true) {
                                            ...
                                            print(
                                              '🔍 DEBUG: Final displayName: $displayName',
                                            );
                ...
                children: [
                  Expanded(
                    child: _modernActionCard(
                      ...
                      onTap: () {
                        // Subscription check disabled - direct access
            ...
            children: [
              Expanded(
                child: _modernActionCard(
                  ...
                  subtitle: 'Send to users',
                  color: CustomColor.primaryColor,
                  onTap: () => controller.navigateToInternalTransferScreen(),
                ),
              ),
              SizedBox(width: 16),
              Expanded(
  ...
  Widget _additionalFeaturesWidget(
    BuildContext context,
    DashboardController controller,
  ) {
    return Container(
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(icon, color: CustomColor.appBarColor, size: 24),
              ),
              SizedBox(width: 16),
              Expanded(
                child: Column(
        ...
        children: [
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              double videoHeight =
                  constraints.maxWidth * 0.6; // 16:10 aspect ratio
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: CustomColor.appBarColor.withValues(
                              alpha: 0.3,
                            ),
                            blurRadius: 15,
                            offset: Offset(0, 5),
  ...
  // Subscription status banner (disabled)
  Widget _subscriptionStatusBanner(BuildContext context) {
    return SizedBox.shrink(); // Subscription functionality disabled
  }
}
