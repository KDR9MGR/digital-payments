  ...
  Future<Map<String, dynamic>> _processP2PTransfer({
    ...
    try {
      ...
      try {
        ...
        // Process P2P transfer using the new payment processing API
        AppLogger.log('Processing P2P transfer via payment API...');
        
        final internalTransferService = InternalTransferService();
        final transferResult = await internalTransferService.sendMoneyViaPaymentAPI(
          receiverEmail: recipientEmail,
          amount: amount,
          currency: normalizedCurrency,
          description: 'P2P Transfer via ${paymentMethod}',
        );
        ...
        if (transferResult['success'] == true) {
          ...
          return {
            ...
            'message': transferResult['message'] ?? 'Transfer completed successfully',
          };
        } else {
