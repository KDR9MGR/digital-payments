...
import 'package:xpay/views/onboarding/onboarding_screen.dart' as stripe_onboarding;
import 'package:xpay/views/payments/send_money_screen.dart' as send_money_simple;
...
import '../views/internal_transfer/internal_transfer_screen.dart';
...
class Routes {
  ...
  static const String internalTransferScreen = '/internalTransferScreen';
  ...
  static List<GetPage> list = [
    ...
    GetPage(name: internalTransferScreen, page: () => InternalTransferScreen()),
    ...
    GetPage(
      name: sendMoneySimpleScreen,
      page: () => send_money_simple.SendMoneyScreen(baseUrl: _detectBaseUrl(), publishableKey: _stripePk),
    ),
    GetPage(
