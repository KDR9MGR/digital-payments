...
class SubscriptionGuardService {
  ...
  /// Check if user has access to premium features (subscription features disabled)
  Future<bool> hasAccess() async {
    try {
      ...
      // Subscription features disabled - grant access to all authenticated users
      AppLogger.log('Access granted - subscription features disabled');
      return true;
    } catch (e) {
