...
class AppleSubscriptionService {
  static final AppleSubscriptionService _instance =
  ...
  static const String _appleOriginalTransactionIdKey =
      'apple_original_transaction_id';
  static const String _appleSubscriptionGroupIdKey =
  ...
  Future<void> initialize() async {
    if (!io.Platform.isIOS) {
      AppLogger.log(
        'Apple Subscription Service: Not running on iOS, skipping initialization',
      );
      return;
    }
  ...
  Future<bool> _validateAppleReceipt(String receiptData) async {
    try {
      ...
      if (result.data['success'] == true) {
        ...
        AppLogger.log(
          'Apple receipt validation failed: ${result.data['error']}',
        );
        return false;
      }
    } catch (e) {
    ...
    try {
      ...
      if (_originalTransactionId != null) {
        await _storage.write(
          _appleOriginalTransactionIdKey,
  ...
  Future<Map<String, dynamic>> getAppleSubscriptionStatus() async {
    try {
      ...
      return {'isActive': false, 'error': e.toString(), 'platform': 'apple'};
    }
  }
